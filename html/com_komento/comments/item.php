	...
	<div class="kt-comment">
		<div class="flex">					
			<div class="flex-grow space-y-md min-w-0">
				...
				<?php if (KT::likes()->isEnabled() || (!$pinned && ($comment->canReplyTo() || $comment->canReport())) || ($comment->isFeatured() && $comment->childs > 0)) { ?>
