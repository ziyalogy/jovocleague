...
<div class="o-editor-wrapper  space-y-md">
	<div class="o-editor is-markitup">
		<div class="o-markitup-editor <?php echo $this->config->get('bbcode_hide_buttons') ? 'fd-markitup-buttons-hidden' : '';?>" data-editor-wrapper>
			<textarea name="comment" class="kt-form-editor__textarea kt-form-bg--0" cols="50" rows="10" placeholder="<?php echo JText::_('COM_KOMENTO_FORM_WRITE_YOUR_COMMENTS'); ?>" data-kt-editor data-preset=""><?php echo $isEdit ? $comment->comment : ''; ?></textarea>
	...
	<?php if ($this->config->get('enable_ratings') || $this->config->get('antispam_min_length_enable') || $this->config->get('antispam_max_length_enable')) { ?>
		<div class="kt-editor-info">
			<div class="kt-editor-action">
				...
				<div class="mr-md">
					<span>
						<?php echo $this->fd->html('label.standard', '<b data-kt-text-counter>0</b>&nbsp; ' . JText::_('COM_KOMENTO_FORM_CHARACTERS_COUNTER'), 'info', [
							'rounded' => false
						]); ?>
					</span>
				</div>
