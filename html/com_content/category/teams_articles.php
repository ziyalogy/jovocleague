		...
		<table class="com-content-category__table category table table-striped table-hover table-borderless border-primary">
				...
				<thead>
					<tr>
						...
						<th scope="col" id="categorylist_header_title">
							...
							<?php echo HTMLHelper::_('grid.sort', 'TEAM_NAME', 'a.title', $listDirn, $listOrder, null, 'asc', '', 'adminForm'); ?>
						</th>
			...
			<?php foreach ($this->items as $i => $article) : ?>
				...
				<td class="list-author">
									...
									<?php echo $article->jcfields['17']->value; ?>
									</span>
					</td>
					<td class="team_logo">
					
		<div class="team_logo">
		<?php echo $article->jcfields['18']->value; ?>
		</div>
					</td>
